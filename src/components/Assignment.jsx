...
const Assignment = ({ assignment, handleDelete }) => {
    ...
    return (
        <div className="border-2 flex flex-col justify-between p-6 rounded-lg dark:border-gray-700 border-gray-200 hover:-translate-y-2 shadow hover:border-2 hover:border-indigo-400 duration-1000">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-2">{description.substring(0, 75)}...</p>
            <p className="mb-1"><span className="text-gray-700 font-medium dark:text-gray-400">Difficulty Level:</span> <span className="font-medium text-gray-600 dark:text-gray-400">{difficulty_level}</span></p>
