    ...
    return (
        <div className="container mx-auto px-5 mb-20">
            <div className="text-center mb-12">
                <h2 className="sm:text-[32px] text-[27px] dark:text-white font-semibold text-gray-800 mb-4">Our Few Feathers</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <div data-aos="flip-left" className="p-5 dark:bg-transparent rounded-lg space-y-4 text-center bg-indigo-100 border-[2px] border-indigo-400">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 pb-2">After cleaning and organizing our closet, in the end we are probably wondering what we are going to do with clothes.</p>
                </div>
                <div data-aos="flip-left" className="p-5 dark:bg-transparent rounded-lg space-y-4 text-center bg-indigo-100 border-[2px] border-indigo-400 transition-all">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 pb-2">Distinctively parallel task magnetic deliverables whereas 2.0 action items. Completely repurpose installed base results.</p>
                </div>
                <div data-aos="flip-left" className="p-5 dark:bg-transparent rounded-lg space-y-4 text-center bg-indigo-100 border-[2px] border-indigo-400 transition-all">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 pb-2">Dynamically incentivize turnkey platforms vis-a-vis 24/365 initiatives. Quickly enable interoperable information.</p>
                </div>
